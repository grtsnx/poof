    ...
    if (compact) {
      return (
        <div className="burn-timer burn-timer--burned burn-timer--burned-compact">
          <span className="burn-timer--burned-line">This address has been burnt to ash.</span>
          <span className="burn-hint">Generate a new one above. It&apos;s free.</span>
        </div>
      )
    }
    return (
      <div className="burn-timer burn-timer--burned">
        ...
        <span>This address has been burnt to ash.</span>
        <span className="burn-hint">Generate a new one above. It&apos;s free.</span>
      </div>
    )
  }
